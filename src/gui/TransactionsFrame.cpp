...
TransactionsFrame::TransactionsFrame(QWidget* _parent) : QFrame(_parent), m_ui(new Ui::TransactionsFrame),
  ...
  m_ui->m_transactionsView->header()->setSectionResizeMode(TransactionsModel::COLUMN_TYPE, QHeaderView::Fixed);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_TYPE, 50);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_STATE, 50);
  ...
  m_ui->m_transactionsView->header()->moveSection( 4, 6 );
}
