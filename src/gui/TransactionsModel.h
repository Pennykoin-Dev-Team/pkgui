...
public:
  enum Columns {
    COLUMN_TYPE = 0, COLUMN_STATE, COLUMN_DATE, COLUMN_AMOUNT, COLUMN_CONFIRMATIONS, COLUMN_ADDRESS, COLUMN_MESSAGE, COLUMN_PAYMENT_ID, COLUMN_HASH, COLUMN_SECRETKEY, COLUMN_FEE,
    COLUMN_HEIGHT,
  };
