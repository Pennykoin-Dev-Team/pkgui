    ...
    else
    {
        ...
        Version remoteVersion = result.toStdString();
         ...
         if (ourVersion < remoteVersion) {
             ...
             if (QMessageBox::warning(nullptr, QObject::tr("New version available"), QObject::tr("There is an update available. Please download now!"), QMessageBox::Ok, QMessageBox::Cancel) == QMessageBox::Ok) {
                 QString link = "https://easypool.pro/pkguise";
