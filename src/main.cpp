...
QGuiApplication::setAttribute(Qt::AA_DisableHighDpiScaling);
  ...
  if (!lockFile.tryLock()) {
    QMessageBox::warning(nullptr, QObject::tr("Fail"), QString("%1 wallet is already running").arg(CurrencyAdapter::instance().getCurrencyDisplayName()));
    return 0;
  }
  ...
  splash->showMessage(QObject::tr("Connecting to the PennyKoin Blockchain..."), Qt::AlignCenter | Qt::AlignBottom, Qt::black);
  app.processEvents();
